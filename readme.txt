...
netrexx/lang/
This contains the runtime package, in which the minimal set of classes is contained that is needed to run a NetRexx program

netrexx/bin/
Contains sample startup scripts
