...
\cite{restrictions}, but in general any program that NetRexxC
...
Java program, as described in the \cite{Using the NetRexxA
API}.
...
synchronized.
\item
Use the NetRexx :kw.exit:ekw. instruction (rather than the \emph{System.exit()}
