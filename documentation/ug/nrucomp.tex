...
on the NetRexx \textbf{options} instruction (see the NetRexx languagen
...
\textbf{package} instruction).  NetRexxC uses either the \emph{javac}
...
\chapter{Programmatic use of the NetRexxC translator}
NetRexxC can be used in a program, to compile \nr{} programs from files,
...
Other uses of the NetRexxA API are beyond the scope
