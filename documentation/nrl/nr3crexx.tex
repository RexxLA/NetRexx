...
\subsection{R\textsc{exx} constructors}\label{refrexxcon}
...
\emph{arg} must not be \textbf{null}.
\end{description}
\subsection{R\textsc{exx} arithmetic methods}\label{refrexxops}
...
type \textbf{boolean}.
\end{description}
\subsection{R\textsc{exx} miscellaneous methods}\label{refrexxmis}
