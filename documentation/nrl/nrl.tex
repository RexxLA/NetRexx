...
\title{\fontspec{Bodoni URW Light}NetR\fontspec{Minion
    Pro}\textsc{exx}\protect\\\fontspec{Bodoni URW Light}Language Reference}
...
This release, 3.11 GA, \marginnote{\color{gray}3.11} is the last of the 3.X series. The new version, 4.01, of which a beta is released simultaneously, will bring \nr{} into the 2020's with support for JDK versions 8 to 17ea. 
\\
\\
