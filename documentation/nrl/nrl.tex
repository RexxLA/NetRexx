...
definition\footnote{This publication is traditionally known as NRL, short
    for NetRexx Language Definition. This title however, has (for
...
language and supercedes all earlier versions. %The chapter ``A Quick
%Tour of the NetRexx Language'' can now be found in the
