\chapter{Appendix D - Installation}\label{installation}
...
For convenience, some shell scripts and batch files are provided in the bin/ directory. On Linux and macOS, 
make sure the scripts are executable.

\begin{lstlisting}
cd ~/nrx/bin
chmod +x NetRexxC.sh nr nrc nrws pipe pipc
\end{lstlisting}
...
Because \nr{} performs a recursive search of the CLASSPATH to resolve packaged classes, a cluttered workspace 
can impact efficiency. \\
Developing in a dedicated project folder rather than your home directory is highly recommended.
