...
See page \pageref{refrexxstream} for more information on class \keyword{RexxStream}.
...
\emph{name}. It returns 1 if at least one character can be read from \emph{name},
