...
\item[lineout(name,string)] returns '1' or '0', indicating whether the second argument has been successfully written to the stream named by the first argument. A result of '1' means an unsuccessful write, see page \pageref{refrexxstream} for Class \keyword{RexxStream} information.
