...
\\\midrule
Pipelines for \nr{} QuickStart Guide & The Data Flow oriented companion to \nr{}, with its z/VM CMS Pipelines compatible syntax, is documented in this manual. It discusses installing and running Pipes for \nr{}, and has ample examples of defining your own stages in \nr{}.
\\\bottomrule
\end{tabularx}
%%% Local Variables: 
%%% mode: latex
