...
\renewcommand{\@makechapterhead}[1]{%
  ...
  {\parindent \z@
   \raggedleft
   \normalfont\fontspec{TeX Gyre Pagella}\LARGE \@chapapp{} \thechapter
   \par\nobreak
   \vskip 10pt
   \hrule height 0.4pt width \textwidth \relax
   \vskip 10pt
   {\normalfont\fontspec{TeX Gyre Pagella}\Huge #1\par}%
   \vskip 40pt
}}
\makeatletter
\renewcommand{\@makeschapterhead}[1]{%
  ...
  {\parindent \z@ \raggedleft
   \normalfont\fontspec{TeX Gyre Pagella}\Large\bfseries #1\par
   \vskip 40pt
  }}
...
\titleformat{\section}
  {\normalfont\fontspec{TeX Gyre Pagella}\Large\bfseries}
  {\thesection}{1em}{}
...
\titlespacing*{name=\chapter,numberless}
  ...
  \renewcommand{\contentsname}{\fontspec{TeX Gyre Pagella}Contents}
  \renewcommand{\indexname}{Index}
  \renewcommand{\listtablename}{\fontspec{TeX Gyre Pagella}List of tables}
  \renewcommand{\listfigurename}{\fontspec{TeX Gyre Pagella}List of figures}
  
  \sectionfont{%
    \hrule                % place a horizontal line
    \vspace{1ex}%         % add some vertical space
    \fontspec{TeX Gyre Pagella}       % set section title size & style
  }
