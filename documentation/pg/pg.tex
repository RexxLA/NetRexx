...
bootstrapped in 1996 and subsequently has been used to compile
...
time. In Git, that is one of the easiest things to do: just
...
\section{Repository}
The \nr{} source code repository is hosted at the SourfeForge Git repository. To get the code
on your system, you should register at the NetRexx project
\url{https://kenai.com/projects/netrexx} and check the repository out
using Git. For this version management package are many
