...
Starting with version 3.07 it is possible
to print directly to a a file using the \texttt{Say} statement, or, for
example, to a file and to Stderr at the same time. Also, a pattern in which there is an
