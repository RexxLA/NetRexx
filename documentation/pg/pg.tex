...
\lstinputlisting[label=nonjava,caption=Output Event Listener]{../../../examples/os/OutputEventListener.nrx} 
...
number of the C++ oriented patterns in Software ?Patterns\footnote[xxx], a fair number owes its existence
