...
\subsubsection{Synchronous communication with unbuffered channel}
...
Two channels are used: a buffered channel to hold the tasks, and a buffered channel for workers to report completion.
