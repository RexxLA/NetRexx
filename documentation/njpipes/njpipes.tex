...
\begin{enumerate}
\item The underlying technology, the JVM, and the chosen implementation language, \nr{}, cause the character representation to be Unicode.
