...
\emph{command}, for OS commands, '<' for reading files on disk, and \emph{literal}, for inserting literal strings into a pipeline.
...
Imagine, for the sake of argument, that you have an
...
\begin{lstlisting}
-- one shot tcpip server receives file b.b from tcpreq

pipe (tcpserv stall 60000 debug 0 )
   tcplisten 1958 timeout 15000 | tcpexample

-- one shot tcpip requestor sends file b.b to tcpserv
